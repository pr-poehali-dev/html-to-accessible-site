  ...
  const consultations = [
    {
      ...
      price: "900 ₽",
      duration: "60 минут",
      desc: "Знакомство, запрос, диагностика. Вы поймёте, можно ли мне доверять. Я пойму, могу ли я вам помочь. Определим направление для дальнейшей работы.",
    ...
    },
    {
      ...
      price: "1 500 ₽",
      duration: "60 минут",
      desc: "«Честный» разбор. Не «поговорили и разошлись». Глубокая проработка запроса, психологические техники, поддержка.",
